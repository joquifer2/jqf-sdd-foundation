...
| Estado | Decision propuesta / pending Reviewer and QA |
...
| Movimiento fisico | NOT EXECUTED |
| Stub legacy | NOT CREATED |
...
Esta decision no ejecuta movimientos, no crea stubs, no modifica el baseline cerrado de SDD Modes y no autoriza Development adicional.
...
## Movimiento futuro propuesto

| ID | Accion | Origen | Destino | Compatibilidad |
| --- | --- | --- | --- | --- |
| DEV-RPN-010 | Move + rename | `specs/spec-001-sdd-modes.architecture.md` | `specs/capabilities/sdd-modes/arch-001-sdd-modes.md` | Stub legacy en ruta origen. |

## Compatibilidad futura

El stub legacy debera declarar:
...
- La opcion A no debe ejecutarse dentro de esta preparacion.
